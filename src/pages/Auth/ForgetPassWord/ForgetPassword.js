        ...
        <Row>
          ...
          <Col className="login-col">
            <div className="sub-title">
              <div className="login-title">{strings["FORGET_Title"]}</div>
              <div className="login-titl">{strings["PASSWORD_TITLE"]}</div>
              <div className="login-subtitle">{strings["FORGET_SUB_TITLE_ONE"]}</div>
              <div className="login-subtitl">{strings["FORGET_SUB_TITLE_TWO"]}</div>
                ...
                {(formMethod) => {
                  return (
                    <>
                      <TextField
                        ...
                        type="text"
                        autoComplete="on"
                        placeholder={strings["EMAILADDRESS"] + strings["*"]}
                  ...
                  /> */}
                      <div className="custombtnfield">
                        <CustomButton type="submit" title={strings["SUBMIT"]} disabled={!formMethod?.formState.isValid} loading={busy} />
                      </div>
...
export default multilanguage(ForgetPassword);